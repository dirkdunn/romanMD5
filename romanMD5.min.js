...
function rot13(r){if("string"==typeof r){var n=["A","a","B","b","C","c","D","d","E","e","F","f","G","g","H","h","I","i","J","j","K","k","L","l","M","m","N","n","O","o","P","p","Q","q","R","r","S","s","T","t","U","u","V","v","W","w","X","x","Y","y","Z","z"],e=r.trim().split("");for(var t in r)-1!==n.indexOf(r[t])&&(e[t]=n.indexOf(r[t])+26<n.length?n[n.indexOf(r[t])+26]:n[n.indexOf(r[t])-26]);return e.join("")}console.error("Wrong parameter type, must be type String.")}
module.exports = function romanMD5(r,o){for(var o=o?o:Math.floor(8*Math.random()+5),t=0;o>t;t++)r=rot13(r),r=MD5(r);return[r,o]};
